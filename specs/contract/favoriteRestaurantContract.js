...
const itActsAsFavoriteRestaurantModel = (favoriteRestaurant) => {
  ...
  it('should refuse a restaurant from being added of it does not have the correct property', async () => {
